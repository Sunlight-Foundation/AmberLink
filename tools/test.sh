...
EXAMPLES="factorial hello hi basic_types_test float_test list_test test_init test_methods test_oop test_overload test_static test_visibility gc_test native_test file_io_test collections_test import_test archive_test net_test ffi_test threads_test"
